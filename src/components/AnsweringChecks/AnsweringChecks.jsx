...
const AnsweringChecks = () => {
  ...
  const fetchChecksData = async () => {
    ...
    try {
      ...
      setToast({
        messageType: "Success",
        message: "Checks loaded successfully.",
      })
    } catch (error) {
      setToast({
        messageType: "Danger",
        message:
          "Something went wrong. Could not fetch checks. Please try again!",
      })
    }
    setLoading(false)
  }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setToast({
        messageType: "danger",
        message:
          "Something went wrong. Could not submit checks. Please try again!",
      })
    }
    setLoading(false)
  }
  ...
  return (
    <div className={styles.AnswerContainer} onKeyDown={handleKeyDown}>
